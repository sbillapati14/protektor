...
[build-status-url]: https://drone-server.555.systems/555platform/protektor
[build-status-image]: https://drone-server.555.systems/api/badges/555platform/protektor/status.svg
